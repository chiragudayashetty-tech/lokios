...
export default function Calendar() {
  ...
  useEffect(() => {
    ...
    if (p.get('google_connected')) {
      setGoogleToast({ type: 'success', msg: '✓ Google Calendar connected! Events will now sync automatically.' })
            ...
            {isGoogleConnected ? (
              ...
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#34d399"/>
                </svg>
